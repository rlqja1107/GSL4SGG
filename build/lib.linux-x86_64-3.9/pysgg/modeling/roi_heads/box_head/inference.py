...
class PostProcessor(nn.Module):
    ...
    def forward(self, x, boxes, relation_mode=False):
        ...
        for i, (prob, boxes_per_img, image_shape) in enumerate(zip(
            ...
            if not self.bbox_aug_enabled:   # False
    ...
    def filter_results(self, boxlist, num_classes, obj_logit=None):
        ...
        if self.nms_filter_duplicates or self.save_proposals: # True
            ...
            final_inds = scores_pre.nonzero(as_tuple = False)
...
def make_roi_box_post_processor(cfg):
    ...
    cls_agnostic_bbox_reg = cfg.MODEL.CLS_AGNOSTIC_BBOX_REG # Flase
