...
_C.REVERSE_PROP = 1
_C.IS_SHIFT = False
_C.IS_REPORTING = False
_C.DIVIDE_RATIO = 0.5
_C.FILL_CRITERIA = "object"
_C.FILL_BG_PROP = 0.1
_C.DEBUG = False
_C.reporting_thres = 0.2
_C.BG_FILTER = False
_C.DATA_DIR = '/home/public/Datasets/CV/vg_bm'
...
# GSL
_C.MODEL.ROI_RELATION_HEAD.GSL_MODULE = CN()
_C.MODEL.ROI_RELATION_HEAD.GSL_MODULE.FILTER_BG = False
_C.MODEL.ROI_RELATION_HEAD.GSL_MODULE.TRAIN_ON_FULLY_CONNECTED = False

_C.MODEL.ROI_RELATION_HEAD.RGCN = CN()
_C.MODEL.ROI_RELATION_HEAD.RGCN.N_BASES = 6
_C.MODEL.ROI_RELATION_HEAD.RGCN.H_DIM = 128
_C.MODEL.ROI_RELATION_HEAD.RGCN.CATEGORY_FILE = 'VG-SGG-Category_v2'
