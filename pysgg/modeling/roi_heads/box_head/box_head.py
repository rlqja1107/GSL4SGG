...
class ROIBoxHead(torch.nn.Module):
    ...
    def __init__(self, cfg, in_channels):
        ...
        self.feature_extractor = make_roi_box_feature_extractor(cfg, in_channels,
                                                                ...
                                                                for_relation=False) # FPN2MLPFeatureExtractor
        self.predictor = make_roi_box_predictor(
            cfg, self.feature_extractor.out_channels) # 4096 # Pretrained
    ...
    def forward(self, features, proposals, targets=None):
        ...
        if self.cfg.MODEL.RELATION_ON: # True
            if self.cfg.MODEL.ROI_RELATION_HEAD.USE_GT_BOX: # False
                ...
                if self.cfg.MODEL.ROI_RELATION_HEAD.USE_GT_OBJECT_LABEL: # False
                    # mode==predcls
                ...
                x, result = self.post_processor((x, class_logits, box_regression), proposals, relation_mode=True) # 여기에서 Bounding Box 목록을 줄여줌
