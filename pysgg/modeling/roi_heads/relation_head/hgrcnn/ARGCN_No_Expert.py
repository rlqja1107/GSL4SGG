...
class ARGCN(torch.nn.Module):
    ...
    def forward(self,      
        ...
        g_rel, etype_rel, etype_rel_inv = self._get_map_idxs(proposals, rel_pair_inds)
    ...
    def _get_map_idxs(self, proposals, rel_pair_inds):
        """
        (P,P) : 0, (P,H) : 1, (P,A) : 2
        (H,P) : 3, (H,H) : 4, (H,A) : 5
        (A,P) : 6, (A,H) : 7, (A,A) : 8
...
class RGCNLayer(MessagePassing):
    ...
    def entity2rel_msg_attn(self, rel, edge_type_rel, edge_type_rel_inv, sub2rel_msg, obj2rel_msg):
        ...
        sub2rel_score = self.entity2rel_attn[rel](sub2rel_msg_mask)
        obj2rel_score = self.entity2rel_attn[rel](obj2rel_msg_mask)

        mask_idx = (sub2rel_score==0).view(-1)
