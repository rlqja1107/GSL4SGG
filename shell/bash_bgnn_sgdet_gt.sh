...
export reporting_thres=0.2
export report_criteria=max
export apply_gt=True
export consideration_non_gt=False
export pretrain_relness=True
export output_dir="checkpoints/${task}_BGNNPredictor_bilvl_${set_on}_refine_${use_obj_refine}_${config}_is_rp(${is_reporting})_rp_thres(${reporting_thres})_rp_criteria(${report_criteria})_gt_(${apply_gt})_consideration_non_gt_${consideration_non_gt}_rel_rel"
