...
# Density
export fill_crieria="edge" # Object를 기준으로
export reverse=False # Use Top or Down
export fill_bg_drop=0.13 # 0.05, 0.07, 0.09, 0.11 
...
export output_dir="checkpoints/${task}_Density_BGNNPredictor_bilvl_${resampling}_is_rp(${is_reporting})_gt_(${apply_gt})_consideration_non_gt_${consideration_non_gt}_reverse(${reverse})_fill_drop(${fill_bg_drop})"
