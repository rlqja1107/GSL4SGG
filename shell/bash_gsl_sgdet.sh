...
export link_loss_type="focal" # bce, focal
export filter_valid=True
export output_dir="checkpoints/${task}_${predictor}_refine_${use_obj_refine}_loss_type(${link_loss_type})_filter_valid(${filter_valid})_${config}"
